...
app.use(cors({
    ...
    allowedHeaders: ['Content-Type', 'Authorization', 'X-Requested-With', 'X-Resume-Preview'],
...
app.get("*", (req, res, next) => {
    ...
    if (acceptsHtml && !isApiRoute && envConfig.frontendUrl) {
        return res.redirect(`${envConfig.frontendUrl}${req.originalUrl}`);
    }
